              ...
              <SwiperSlide className="slide">
                ...
                <div className="warningBox">
                  <div className="flex">
                    ...
                    <div className="desc">
                      하루에 3번 도전이 가능하고 한 판당 life 개수는 5개입니다.
                    </div>
                  </div>
                  <div className="flex">
                    <div className="order">•</div>
              ...
              <SwiperSlide className="slide">
                ...
                <div className="warningBox">
                  <div className="flex">
                    <div className="order">•</div>
                    <div className="desc">
                      하루에 1번만 도전이 가능하고 life 개수는 5개입니다.
                    </div>
                  </div>
                  <div className="flex">
                    <div className="order">•</div>
                    <div className="desc">
                      hi-five에서는 쿠폰 사용이 불가능합니다.
                    </div>
                  </div>
                  <div className="flex">
                    <div className="order">•</div>
            ...
            <Swiper
              ...
              <SwiperSlide className="slide">
                ...
                <div className="warningBox">
                  <div className="flex">
                    <div className="order">•</div>
                    <div className="desc">
                      SpeeDoodle은 친구들과 함께할 수 있는 멀티 게임입니다.
                    </div>
                  </div>
                  <div className="flex">
                    <div className="order">•</div>
                  ...
                  <div className="flex">
                    <div className="order">•</div>
                    <div className="desc">
                      히스토리 페이지를 통해 자신과 친구들의 게임 결과를 확인할
                      수 있으며 이미지 다운로드가 가능합니다.
                    </div>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="slide">
                ...
                <div className="flex">
                  <div className="order">1.</div>
                  <div className="desc">
                    2명 이상 6명 이하 유저들이 대기방에 모여 모드를 선택한 후
                    게임을 시작합니다.
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="slide">
                ...
                <div className="flex">
                  <div className="order">2.</div>
                  <div className="desc">
                    게임이 시작되면 모든 유저들에게 동일한 키워드가 주어지고,
                    유저들은 키워드를 그림으로 표현합니다.
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="slide">
                ...
                <div className="flex">
                  <div className="order">3.</div>
                  <div className="desc">
                    AI가 그림을 분석하여 제시된 키워드로 인식한 순서대로 순위가
                    매겨집니다.
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="slide">
                ...
                <div className="flex">
                  ...
                  <div className="desc">
                    총 5라운드로 진행되며, 각 라운드의 통과 시간을 종합하여 최종
                    순위가 매겨집니다.
                  </div>
                </div>
              </SwiperSlide>
